...
if (move_uploaded_file($_FILES['imagem']['tmp_name'], $caminho_arquivo)) {
	...
	$sql = "INSERT INTO estudante (nome, data_nascimento, sexo, instituicao, curso, cpf, validade, imagem, modificado) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())";
	...
	if (mysqli_stmt_execute($stmt)) {
		...
		header("Location: ../../src/admin/cad_aluno.php");
	} else {
